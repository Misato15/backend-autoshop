...
@model({settings: {idInjection: false, mssql: {schema: 'dbo', table: 'Departments'}}})
export class Departments extends Entity {
  ...
  @property({
    ...
    length: 25,
    generated: 0,
    mssql: {columnName: 'Name', dataType: 'varchar', dataLength: 25, dataPrecision: null, dataScale: null, nullable: 'NO', generated: 0},
  })
  name: string;
